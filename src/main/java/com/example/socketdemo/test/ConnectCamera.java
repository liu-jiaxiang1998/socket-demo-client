...
//        String tempData = "02 00 33 04 00 01 11 01 7F 39 03";
        ...
        try (Socket socket = new Socket()) {
            ...
            System.out.println("Connect " + serverIp + " over.");
...
//                    String data1 = HexUtil.byteArrayToHexString(dataBody).toUpperCase();
                    ...
                    System.out.println("检测编号" + bianhao + "    检测时间：" + nian + "年" + yue + "月" + ri + "日" + shi + "点" + fen + "分" + miao + "秒" + haomiao + "毫秒");
                    ...
                    if (chepaihao.equals("20202020202020202020202020200000") || !chepaihao.equals("20202020202020202020202020200000")) {
                        System.out.println("车道号为" + chedaohao);
                        String chepaihaozhongwen = new String(HexUtil.hexStringToByteArray(chepaihao)).replace("\u0000", "");
                        System.out.println("车牌颜色 " + new String(HexUtil.hexStringToByteArray(chepaiyanse)) + " 车牌号是" + chepaihaozhongwen);
...
//                            String pictureName = nian + "_" + yue + "_" + ri + "_" + shi + "_" + fen + "_" + miao + "_" + haomiao + "_" + chedaohao + "_" + chedao + "_" + chepaihaozhongwen + "_" + count + ".jpg";
                    ...
                    System.out.println("抓图时间：" + (timeend1 - time1) + "ms");
                    System.out.println("接收时间：" + (timeend2 - timeend1) + "ms");
                    System.out.println("解码时间：" + (timeend3 - timeend2) + "ms");
                    System.out.println("总时间：" + (timeend3 - time1) + "ms");
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
